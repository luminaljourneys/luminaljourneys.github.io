...
- Name: landing.spec.js >> Landing Page >> nav shows "Book a Consultation" CTA
- Location: tests/landing.spec.js:25:3
...
Locator: getByRole('button', { name: /book a consultation/i }).first()
Expected: visible
Timeout: 5000ms
