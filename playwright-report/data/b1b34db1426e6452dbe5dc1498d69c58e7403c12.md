...
- Name: navigation.spec.js >> Navigation & Routing >> dynamic page "← Home" button navigates to /
- Location: tests/navigation.spec.js:57:3
...
Locator: getByRole('button', { name: /home|back to home/i }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /home|back to home/i }).first()
